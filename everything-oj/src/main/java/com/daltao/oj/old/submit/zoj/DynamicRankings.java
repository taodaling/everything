 ...
 */
public class DynamicRankings {
    static final int N_LIMIT = 50000;
    static final int SNODE_CACHE = 1000001;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0, bound = input.nextInteger(); i < bound; i++) {
            DynamicRankings solution = new DynamicRankings();
            solution.init();
            solution.solve();
        }
    }
    ...
    public static class BlockReader {
        ...
        public BlockReader(InputStream is) throws IOException {
            this(is, 8192);
        }

        public BlockReader(InputStream is, int bufSize) throws IOException {
            this.is = is;
