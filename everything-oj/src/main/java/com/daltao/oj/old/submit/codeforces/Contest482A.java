...
public class Contest482A {
    ...
    public static void init() throws FileNotFoundException {
        if (System.getProperty("ONLINE_JUDGE") == null) {
            input = new BlockReader(new FileInputStream("E:\\DATABASE\\TESTCASE\\codeforces\\Contest482A.in"));
            output = System.out;
        } else {
    ...
    public static void solve() {
        long n = Long.parseLong(input.nextBlock()) + 1;
        if (n == 1) {
            output.println(0);
        } else if (n % 2 == 0) {
            output.println(n / 2);
    ...
    public static class Debug {
        ...
        public void statistic() {
            ...
            if (stack.size() > 0) {
                throw new RuntimeException("Exists unexited tag");
            }
            System.out.println("\n------------------------------------------");
