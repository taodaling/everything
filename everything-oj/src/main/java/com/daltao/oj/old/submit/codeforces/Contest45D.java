...
public class Contest45D {
    public static void main(String[] args) throws FileNotFoundException {
        boolean local = System.getProperty("ONLINE_JUDGE") == null;
        IOUtil io;
        if (local) {
            io = new IOUtil(new FileInputStream("E:\\DATABASE\\TESTCASE\\codeforces\\Contest45D.in"), new FileOutputStream("E:\\DATABASE\\TESTCASE\\codeforces\\Contest45D.out"));
        } else {
