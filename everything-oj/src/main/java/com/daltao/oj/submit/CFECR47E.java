...
public class CFECR47E {
    public static void main(String[] args) throws Exception {
        ...
        FastIO io = local ? new FastIO(new FileInputStream("/Users/daltao/DATABASE/TESTCASE/CFECR47E.in"), System.out, charset) : new FastIO(System.in, System.out, charset);
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            int[] a = new int[n + 1];
            for (int i = 1; i <= n; i++) {
                a[i] = (a[i - 1] + io.readInt()) % P;
            }

            int[] calc = new int[n + 1];
            for (int i = 1; i <= n; i++) {
                    calc[i] = (int) ((2L * calc[i - 1] + a[i - 1]) % P);
            }
            for (int i = 1; i <= n; i++) {
                calc[i] = (calc[i] + a[i]) % P;
            }
