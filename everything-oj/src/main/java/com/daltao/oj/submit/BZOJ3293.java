...
public class BZOJ3293 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            for (int i = 1; i <= n; i++) {
                preSum[i] = preSum[i - 1] + io.readInt();
            }
            long avg = preSum[n] / n;
            Long[] offsets = new Long[n];
            for (int i = 0; i < n; i++) {
                offsets[i] = -(preSum[i + 1] - preSum[1] - i * avg);
            }
            long center = (Sortable.theKthSmallestElement(offsets, new Comparator<Long>() {
                @Override
                public int compare(Long o1, Long o2) {
                    return o1.compareTo(o2);
                }
            }, 0, n, n / 2 + 1) +
                    Sortable.theKthSmallestElement(offsets, new Comparator<Long>() {
                        @Override
                        public int compare(Long o1, Long o2) {
                            return o1.compareTo(o2);
                        }
