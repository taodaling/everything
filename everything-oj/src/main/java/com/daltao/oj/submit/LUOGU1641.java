...
public class LUOGU1641 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            int n = io.readInt();
            int m = io.readInt();
            NumberTheory.Modular mod = new NumberTheory.Modular(20100403);
            NumberTheory.Composite comp = new NumberTheory.Composite(n + m, mod);
            int ans = comp.composite(n + m, n);
            ans = mod.subtract(ans, comp.composite(n + m, n + 1 + 0));
            io.cache.append(ans);
        }
    }
