...
public class POJ1279 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            GeometryUtils.HalfPlaneIntersection hpi = new GeometryUtils.HalfPlaneIntersection(pp.asLines(), false);
            if (!hpi.hasSolution) {
                io.cache.append(String.format("%.2f", 0d)).append('\n');
                return;
            }
            pp = hpi.convex.asPoints();
            io.cache.append(String.format("%.2f", new GeometryUtils.Area().areaOfConvex(pp))).append('\n');
        }
    }
