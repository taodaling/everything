...
public class BZOJ1091 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            GeometryUtils.Point2D[] pts = new GeometryUtils.Point2D[p];
            for (int i = 0; i < p; i++) {
                pts[i] = new GeometryUtils.Point2D(io.readDouble(), io.readDouble());
            }
    ...
    public static class Coordination2D {
        ...
        public static Coordination2D ofReflectOnXAxis() {
            Matrix mat = new Matrix(3, 3);
            mat.asStandard();
            mat.set(1, 1, -1);
            return new Coordination2D(mat);
        ...
        public static Coordination2D ofReflect(double x, double y) {
            Coordination2D xAxis = ofXAxis(x, y);
            Coordination2D reflectOnXAxis = ofReflectOnXAxis();
            Matrix mat = Matrix.mul(xAxis.mat, Matrix.mul(reflectOnXAxis.inv, xAxis.inv));
            return new Coordination2D(mat);
        }
