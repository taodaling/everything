...
public class CFCR493D {
    public static void main(String[] args) throws Exception {
        ...
        FastIO io = local ? new FastIO(new FileInputStream("E:\\DATABASE\\TESTCASE\\CFCR493D.in"), new FileOutputStream("E:\\DATABASE\\TESTCASE\\CFCR493D.out"), charset) : new FastIO(System.in, System.out, charset);
