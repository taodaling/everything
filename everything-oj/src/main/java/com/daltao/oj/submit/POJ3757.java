...
public class POJ3757 {
    ...
    public static class Task implements Runnable {
        ...
        final Debug debug;
        int inf = (int) 1e8;
        double[][] machines = new double[20000][3];
        ...
        public void solve() {
            ...
            for (int i = 0; i < n; i++) {
                ...
                machines[i][1] = 1.0 / (1.0 / a + 1.0 / b);
                machines[i][0] = c * machines[i][1] * f;
            }
            double l = -1e10;
            double r = 0;
            while (r - l > 1e-8) {
                ...
                for (int i = 0; i < n; i++) {
                    machines[i][2] = calc(machines[i], m);
                }
                Sortable.theKthSmallestElement(machines, new Comparator<double[]>() {
                    @Override
            ...
            io.cache.append(String.format("%.4f", -(l))).append('\n');
        }

        public static double calc(double[] a, double m) {
            return -a[0] - m * a[1];
        }
    }
