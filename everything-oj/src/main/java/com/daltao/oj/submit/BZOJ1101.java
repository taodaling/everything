...
public class BZOJ1101 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            NumberTheory.MultiplicativeFunctionSieve sieve = new NumberTheory.MultiplicativeFunctionSieve(limit, true, false, false);
            long[] preSum = new long[limit + 1];
            ...
            for (int i = 0; i < n; i++) {
                ...
                NumberTheory.FloorDivisionOptimizer d1 = new NumberTheory.FloorDivisionOptimizer(a, 1, a);
                NumberTheory.FloorDivisionOptimizer d2 = new NumberTheory.FloorDivisionOptimizer(b, 1, b);
                ...
                for (int l = 1, r; l <= a; l = r + 1) {
                    r = Math.min(a / (a / l), b / (b / l));
                    ans += (preSum[r] - preSum[l - 1]) * (a / l) * (b / l);
                }
