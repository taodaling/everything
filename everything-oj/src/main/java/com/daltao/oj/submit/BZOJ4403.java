...
public class BZOJ4403 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            MathUtils.Composite composite = new MathUtils.Composite(p - 1, modular);
            ...
            while (t-- > 0) {
                ...
                int l = io.readInt();
                int r = io.readInt();
                int c = modular.valueOf(lucas.composite(n + r - l + 1, n) - 1);
                io.cache.append(c).append('\n');
            }
        }
    }
