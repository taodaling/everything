...
public class POJ1286 {
    ...
    public static class Task implements Runnable {
        ...
        int[] ans = new int[]{0, 3,6,10,21,39,92,198,498,1219,3210,8418,22913,62415,173088,481598,1351983,3808083,10781954,30615354,87230157,249144711,713387076,2046856566};
        ...
        public void solve(int n) {
            io.cache.append(ans[n]).append('\n');
        }

        public long loop(int n, int step) {
        ...
        public long rotate(int n) {
            int numberOfCircle = n / 2;
            long sum = 1;
        ...
        public int rotateByVertex(int n) {
            int numberOfCircle = n / 2 + 1;
            int sum = 1;
            for (int i = 0; i < numberOfCircle; i++) {
                sum *= 3;
            }
