...
public class BZOJ1699 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            Integer[] heights = new Integer[n + 1];
            heights[0] = 0;
            for (int i = 1; i <= n; i++) {
                heights[i] = io.readInt();
            }

            St<Integer> minSt = new St(heights, n + 1, new Comparator<Integer>() {
                @Override
            ...
            St<Integer> maxSt = new St(heights, n + 1, new Comparator<Integer>() {
                @Override
                public int compare(Integer o1, Integer o2) {
            ...
            for (int i = 0; i < q; i++) {
                int l = io.readInt();
                int r = io.readInt();
                io.cache.append(maxSt.query(l, r) - minSt.query(l, r)).append('\n');
            }
        }
    }
