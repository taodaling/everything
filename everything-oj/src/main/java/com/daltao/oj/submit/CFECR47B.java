...
public class CFECR47B {
    public static void main(String[] args) throws Exception {
        ...
        FastIO io = local ? new FastIO(new FileInputStream("E:\\DATABASE\\TESTCASE\\CFECR47B.in"), System.out, charset) : new FastIO(System.in, System.out, charset);
            ...
            for (int i = 0; i < len; i++) {
                switch (s[i]) {
                    case '0':
                        ...
                        break;
                    case '1':
                        fromIndex[1] = Math.max(fromIndex[1], i + 1);
                        while (fromIndex[1] < len && (s[fromIndex[1]] == '1' || s[fromIndex[1]] == 0 )) {
                            fromIndex[1]++;
                        }
                        if (fromIndex[1] < len && s[fromIndex[1]] == '0') {
                            io.cache.append('0');
                            s[fromIndex[1]] = 0;
                            i--;
                        } else {
                        ...
                        break;
                    case '2':
                        fromIndex[2] = Math.max(fromIndex[2], i + 1);
                        while (fromIndex[2] < len && (s[fromIndex[2]] != '1')) {
                            fromIndex[2]++;
                        }

                        if (fromIndex[2] < len && s[fromIndex[2]] == '1') {
                            io.cache.append('1');
                            s[fromIndex[2]] = 0;
                            i--;
                        } else {
