...
public class CFCR493E {
    public static void main(String[] args) throws Exception {
        ...
        FastIO io = local ? new FastIO(new FileInputStream("E:\\DATABASE\\TESTCASE\\CFCR493E.in"), new FileOutputStream("E:\\DATABASE\\TESTCASE\\CFCR493E.out"), charset) : new FastIO(System.in, System.out, charset);
