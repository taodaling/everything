...
public class CFCR493F {
    public static void main(String[] args) throws Exception {
        ...
        FastIO io = local ? new FastIO(new FileInputStream("E:\\DATABASE\\TESTCASE\\CFCR493F.in"), new FileOutputStream("E:\\DATABASE\\TESTCASE\\CFCR493F.out"), charset) : new FastIO(System.in, System.out, charset);
