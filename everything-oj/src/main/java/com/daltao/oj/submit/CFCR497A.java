...
public class CFCR497A {
    public static void main(String[] args) throws Exception {
        ...
        FastIO io = local ? new FastIO(new FileInputStream("E:\\DATABASE\\TESTCASE\\CFCR497A.in"), System.out, charset) : new FastIO(System.in, System.out, charset);
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            int greater = 0;
            int cnt = 0;
            for (; less < n && greater < n; less++) {
                while (greater < n && data[greater] <= data[less]) {
                    greater++;
                }
                if (greater < n && data[greater] > data[less]) {
                    cnt++;
                    greater++;
                }
            }
