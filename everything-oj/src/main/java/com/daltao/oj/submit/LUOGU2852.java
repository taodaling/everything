...
public class LUOGU2852 {
    ...
    public static class Task implements Runnable {
        ...
        public long hash(int l, int r) {
            return (((long) h31.hash(l, r)) << 31) | h11.hash(l, r);
        }
        ...
        public void solve() {
            ...
            h11 = new Hash(data, 11);
            h31 = new Hash(data, 31);
