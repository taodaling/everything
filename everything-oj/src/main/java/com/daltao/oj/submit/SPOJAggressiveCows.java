...
public class SPOJAggressiveCows {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            Randomized.randomizedArray(position, 0, n);
            Arrays.sort(position, 0, n);

            int l = 0;
            int r = 1000000000;
            while (l != r) {
                int m = (l + r + 1) >> 1;
                if (possible(position, n, c, m)) {
                    l = m;
                } else {
                    r = m - 1;
                }
        ...
        //cos[i+1]>=cow[i]+dis
        private static boolean possible(int[] position, int n, int c, int dis) {
            int cnt = 1;
            int pos = position[0];
            for (int i = 1; i < n; i++) {
