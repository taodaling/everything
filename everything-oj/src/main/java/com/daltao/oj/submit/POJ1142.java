...
public class POJ1142 {
    ...
    public static class Task implements Runnable {
        ...
        MathUtils.PollardRho rho = new MathUtils.PollardRho();
        MathUtils.MillerRabin rabin = new MathUtils.MillerRabin();
        ...
        public void solve() {
            while (true) {
                ...
                for (int i = n + 1; ; i++) {
                    ...
                    if (sumOfFactors(i) == sumOfEachDigits(i)) {
        ...
        public int sumOfEachDigits(int x) {
            return x == 0 ? 0 : (x % 10 + sumOfEachDigits(x / 10));
        }
        ...
        public int sumOfFactors(int x) {
            ...
            for (int i = 2; i * i <= x; i++) {
                if (x % i == 0) {
                    return sumOfFactors(i) + sumOfFactors(x / i);
                }
            }
            return sumOfEachDigits(x);
        }
    }
