...
public class BZOJ2460 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            int n = io.readInt();
            long[][] stones = new long[n][2];
            for (int i = 0; i < n; i++) {
                stones[i][0] = io.readLong();
                stones[i][1] = io.readInt();
            }

            Arrays.sort(stones, new Comparator<long[]>() {
                @Override
