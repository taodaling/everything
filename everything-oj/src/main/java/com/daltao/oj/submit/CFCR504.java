...
public class CFCR504 {
    public static void main(String[] args) throws Exception {
        ...
        FastIO io = local ? new FastIO(new FileInputStream("E:\\DATABASE\\TESTCASE\\CFCR504.in"), System.out, charset) : new FastIO(System.in, System.out, charset);
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            if (index < 0) {
                io.cache.append(s.equals(t) ? YES : NO);
                return;
            }
            ...
            if (t.length() == s.length() + 1 && t.startsWith(prefix) && t.endsWith(suffix)) {
                io.cache.append(YES);
            } else {
                io.cache.append(NO);
            }
