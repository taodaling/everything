...
public class BZOJ2330 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            int n = io.readInt();
            int k = io.readInt();
            DifferenceConstraintSystem dcs = new DifferenceConstraintSystem(n + 1);
            ...
            for (int i = 0; i < k; i++) {
                ...
                switch (x) {
                    case 1:
                        dcs.differenceEqualTo(a, b, 0);
                        break;
                    case 2:
                        dcs.differenceLessThan(a, b, 0);
                        break;
                    case 3:
                        dcs.differenceGreaterThanOrEqualTo(a, b, 0);
                        break;
                    case 4:
                        dcs.differenceGreaterThan(a, b, 0);
                        break;
                    case 5:
                        dcs.differenceLessThanOrEqualTo(a, b, 0);
                        break;
                }
            }
            ...
            long total = -n;
            for (int i = 1; i <= n; i++) {
                total += dcs.possibleSolutionOf(i);
            }
