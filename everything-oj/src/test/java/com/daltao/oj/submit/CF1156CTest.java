 ...
 */
public class CF1156CTest {
    @Test
    public void test() {
        Assertions.assertTrue(new TestCaseExecutor.Builder()
                .setTestTime(10000).setInputFactory(new Generator())
                .setActualSolution(() -> new Runnable2OJSolution(new MainMethod2Runnable(CF1156C.class)))
                .setExpectedSolution(() -> new Runnable2OJSolution(new MainMethod2Runnable(C2.class)))
                .build().call()
        );
    }
...
//				if(get(pos))size--;
    ...
    public static class Generator extends RandomFactory {
        ...
        public Input newInstance() {
            ...
            int n = nextInt(2, 5);
            int z = nextInt(1, (int) 1e9);
            input.add(n).add(z);
            for (int i = 0; i < n; i++) {
                input.add(nextInt(1, (int) 1e9));
            }
            return input.end();
        }
    }
