 ...
 * @author <Authors name>
 * @version 1.0
 * @since <pre>ËÄÔÂ 17, 2019</pre>
 */
public class CF1119FTest {
    @Test
    public void test() {
        Assertions.assertTrue(
                new TestCaseExecutor.Builder()
                        ...
                        .setActualSolution(() -> new Runnable2OJSolution(new MainMethod2Runnable(CF1119F.class)))
                        .build().call()
        );
    }
    ...
    public static class Generator extends RandomFactory {
        ...
        public Input newInstance() {
            ...
            int n = nextInt(250000, 250000);
            input.add(n);
            for (int i = 2; i <= n; i++) {
                input.add(String.format("%d %d %d", i / 2, i, nextInt(1, 1000000)));
            }
            return input.end();
        }
    }
