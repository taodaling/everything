...
import com.daltao.test.TestCase;
...
public class AGC004ETest {
    ...
    public void test(){
        ...
        .setActualSolution(() -> new Runnable2OJSolution(new MainMethod2Runnable(AGC004E.class)))
        .setTestTime(10000)
        .build().call());
    }
    ...
    public static class Generator extends RandomFactory {
        ...
        public Input newInstance() {
            ...
            for (int i = 0; i < h; i++) {
                for (int j = 0; j < w; j++) {
                    mat[i][j] = nextInt(1, 2) == 1 ? 'o' : '.';
                }
            }

            mat[nextInt(0, h - 1)][nextInt(0, w - 1)] = 'E';
