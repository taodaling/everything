...
public class HDU1695V2Test {
    @Test
    public void test() {
        Assertions.assertTrue(
                new TestCaseExecutor.Builder()
                        .setActualSolution(new OJMainSolution(HDU1695V2.class))
    ...
    public static class Solution {
        ...
        public static void main(String[] args) throws FileNotFoundException {
            ...
            for (int i = 1, bound = input.nextInteger(); i <= bound; i++) {
                builder.setLength(0);
                builder.append("Case ").append(i).append(": ").append(solution.solve());
    ...
    public static class Generator extends RandomFactory {
        ...
        public Input newInstance() {
            ...
            input.add(n);
            for (int i = 0; i < n; i++) {
                input.add(String.format("1 %d 1 %d %d", nextInt(1, 100000), nextInt(1, 100000), nextInt(1, 10)));
            }
            input.end();
            return input;
        }
