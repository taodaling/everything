...
public class DESTest {
    public static void main(String[] args) {
        ...
        String str = "{\"serial_number\":\"201904201605499524\",\"mobile\":\"10002\"}";
     ...
     * DES算法密钥
     */
    private static final byte[] DES_KEY = "D3B5D36AE575541A3EED90E23C10D754".getBytes(StandardCharsets.UTF_8);
